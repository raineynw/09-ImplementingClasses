...
class Point(object):
    ...
    def __init__(self,x_val,y_val):
        ...
        self.distance = 0
        self.originalx = x_val
        self.originaly = y_val
    ...
    def get_distance_from_start(self):
        dx = (self.x-self.originalx)**2
        dy = (self.y-self.originaly)**2
        self.distance = math.sqrt(dx+dy)
        return self.distance
    ...
    def closer_to(self,P2,P3):
        ...
        if self.distance1 > self.distance:
            return P3
        return P2

    def halfway_to(self,P2):
        self.halfpoint = self.get_distance_traveled(self,P2)/2
